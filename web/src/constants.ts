...
export const Icons = {
  ...
  Archive: () => React.createElement(
    ...
    React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3.75h3.75M12 11.25h-3.75m-6-3.75h19.5M3 3.75h19.5" })
  ),
